import { Option, OptionGroup } from './components/Select'
import { Palette } from './types'

// To generate a new version:
// cd backend && python3 list_devices.py

export const devices: OptionGroup<Option>[] = [
  {
    label: 'Generic',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'pimoroni.hyperpixel4', label: 'Pimoroni HyperPixel 4.0"' },
      { value: 'pimoroni.hyperpixel4_touch', label: 'Pimoroni HyperPixel 4.0" Touch' },
      { value: 'pimoroni.hyperpixel4sq', label: 'Pimoroni HyperPixel 4.0" Square' },
      { value: 'pimoroni.hyperpixel4sq_touch', label: 'Pimoroni HyperPixel 4.0" Square Touch' },
    ],
  },
  {
    label: 'Waveshare',
...
export const withCustomPalette: Record<string, Palette> = {
  ...
  'pimoroni.inky_impression_4_spectra6': spectraPalettes[0],
  'pimoroni.inky_impression_7': spectraPalettes[0],
  'pimoroni.inky_impression_7_2025': spectraPalettes[0],
