...
export const devices: Option[] = [
  ...
  { value: 'waveshare.EPD_2in13bc', label: 'Waveshare 2.13" (BC) 212x104 Black/White/Red' },
  ...
  { value: 'waveshare.EPD_2in13g', label: 'Waveshare 2.13" (G) 250x122 Black/White/Yellow/Red (not implemented)' },
  ...
  { value: 'waveshare.EPD_2in36g', label: 'Waveshare 2.36" (G) 296x168 Black/White/Yellow/Red (not implemented)' },
  ...
  { value: 'waveshare.EPD_2in66g', label: 'Waveshare 2.66" (G) 360x184 Black/White/Yellow/Red (not implemented)' },
  { value: 'waveshare.EPD_2in7', label: 'Waveshare 2.7" 264x176 4 Grayscale (not implemented!)' },
  ...
  { value: 'waveshare.EPD_2in7_V2', label: 'Waveshare 2.7" (V2) 264x176 4 Grayscale (not implemented!)' },
  { value: 'waveshare.EPD_2in9_DES', label: 'Waveshare 2.9" (DES) 296x128 Black/White' },
  { value: 'waveshare.EPD_2in9_V2', label: 'Waveshare 2.9" (V2) 296x128 4 Grayscale (not implemented!)' },
  { value: 'waveshare.EPD_2in9d', label: 'Waveshare 2.9" (D) 296x128 Black/White' },
  { value: 'waveshare.EPD_2in9bc', label: 'Waveshare 2.9" (BC) 296x128 Black/White/Red' },
  ...
  { value: 'waveshare.EPD_3in0g', label: 'Waveshare 3.0" (G) 400x168 Black/White/Yellow/Red (not implemented)' },
  { value: 'waveshare.EPD_3in52', label: 'Waveshare 3.52" 360x240 Black/White' },
  { value: 'waveshare.EPD_3in7', label: 'Waveshare 3.7" 480x280 4 Grayscale (not implemented!)' },
  { value: 'waveshare.EPD_4in01f', label: 'Waveshare 4.01" (F) 640x400 7 Color (not implemented!)' },
  { value: 'waveshare.EPD_4in2bc', label: 'Waveshare 4.2" (BC) 400x300 Black/White/Red' },
  { value: 'waveshare.EPD_4in2_V2', label: 'Waveshare 4.2" (V2) 400x300 4 Grayscale (not implemented!)' },
  { value: 'waveshare.EPD_4in2', label: 'Waveshare 4.2" 400x300 4 Grayscale (not implemented!)' },
  { value: 'waveshare.EPD_4in2b_V2', label: 'Waveshare 4.2" (B V2) 400x300 Black/White/Red' },
  { value: 'waveshare.EPD_4in26', label: 'Waveshare 4.26" 800x480 4 Grayscale (not implemented!)' },
  { value: 'waveshare.EPD_4in37g', label: 'Waveshare 4.37" (G) 512x368 Black/White/Yellow/Red (not implemented)' },
  { value: 'waveshare.EPD_4in37b', label: 'Waveshare 4.37" (B) 480x176 Black/White/Red' },
  { value: 'waveshare.EPD_5in65f', label: 'Waveshare 5.65" (F) 600x448 7 Color (not implemented!)' },
  ...
  { value: 'waveshare.EPD_5in83bc', label: 'Waveshare 5.83" (BC) 600x448 Black/White/Red' },
  { value: 'waveshare.EPD_5in84', label: 'Waveshare 5.84" 768x256 Black/White' },
  { value: 'waveshare.EPD_7in3g', label: 'Waveshare 7.3" (G) 800x480 Black/White/Yellow/Red (not implemented)' },
  { value: 'waveshare.EPD_7in3f', label: 'Waveshare 7.3" (F) 800x480 7 Color (not implemented!)' },
  ...
  { value: 'waveshare.EPD_7in5bc', label: 'Waveshare 7.5" (BC) 640x384 Black/White/Red' },
