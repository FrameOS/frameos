...
export interface fontsModelValues {
  fontLoadAttempts: Record<string, number>
  fontLoaded: Record<string, boolean>
  fontLoading: Record<string, boolean>
  fonts: FontMetadata[]
  fontsByName: Record<string, FontMetadata[]>
  fontsByNameOptions: {
    label: string
    value: string
  }[]
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface fontsModelActions {
  loadFont: (font: FontMetadata) => {
    font: FontMetadata
  }
  loadFonts: () => any
  loadFontsFailure: (
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface fontsModelMeta {
  __keaTypeGenInternalSelectorTypes: {
    fontsOptions: (fonts: FontMetadata[]) => {
      label: string
      value: string
    }[]
    fontsByName: (fonts: FontMetadata[]) => Record<string, FontMetadata[]>
    fontsByNameOptions: (fontsByName: Record<string, FontMetadata[]>) => {
      label: string
      value: string
    }[]
    weightsByNameOptions: (fontsByName: Record<string, FontMetadata[]>) => Record<
      string,
      {
        label: string
        value: string
...
export type fontsModelType = MakeLogicType<fontsModelValues, fontsModelActions, Record<string, any>> & fontsModelMeta
...
export const fontsModel = kea<fontsModelType>([
  ...
  selectors({
    fontsOptions: [
      (s) => [s.fonts],
      (fonts: fontsModelValues['fonts']): { label: string; value: string }[] =>
        [
          { label: '- Default -', value: '' },
          ...fonts.map((font) => ({
    ...
    fontsByNameOptions: [
      (s) => [s.fontsByName],
      (fontsByName: fontsModelValues['fontsByName']): { label: string; value: string }[] => [
        { label: '- Default -', value: '' },
    ...
    weightsByNameOptions: [
      (s) => [s.fontsByName],
      (fontsByName: fontsModelValues['fontsByName']): Record<string, { label: string; value: string }[]> =>
        Object.fromEntries(
