...
export interface embeddedUsbLogsModelValues {
  usbLogStreamStatesByFrameId: Record<FrameId, EmbeddedUsbLogStreamState>
  usbLogsByFrameId: Record<FrameId, LogType[]>
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface embeddedUsbLogsModelActions {
  appendUsbLog: (log: LogType) => {
    log: LogType
  }
  setUsbLogStreamState: (
    frameId: FrameId,
    streamState: EmbeddedUsbLogStreamState
  ) => {
    frameId: FrameId
    streamState: EmbeddedUsbLogStreamState
  }
  startUsbLogStream: (frameId: FrameId) => {
    frameId: FrameId
  }
...
export type embeddedUsbLogsModelType = MakeLogicType<embeddedUsbLogsModelValues, embeddedUsbLogsModelActions>
