...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface logsLogicActions {
  ...
  setFullLogDownloading: (downloading: boolean) => {
    downloading: boolean
  }
...
export interface logsLogicMeta {
  ...
  __keaTypeGenInternalSelectorTypes: {
    filteredLogs: (logs: LogType[], logSearch: string) => LogType[]
    ipAddresses: (logs: LogType[]) => string[]
  }
}

export type logsLogicType = MakeLogicType<logsLogicValues, logsLogicActions, LogsLogicProps> & logsLogicMeta
...
export const logsLogic = kea<logsLogicType>([
  ...
  selectors({
    filteredLogs: [
      ...
      (logs: logsLogicValues['logs'], logSearch: logsLogicValues['logSearch']) => {
