...
export function SceneSource() {
  ...
  const { selectedSceneId, selectedSceneName } = useValues(panelsLogic({ frameId: frame.id }))
    ...
    <div className="space-y-2 h-full">
      {sceneSource === '' && sceneSourceLoading ? (
        ...
        <Editor
          ...
          value={
            `# This code is autogenerated. src/scenes/scene_${sceneFile}.nim\n` +
            (sceneSource || 'Error generating source. Make sure to save the scene between changes.')
          }
          theme="darkframe"
