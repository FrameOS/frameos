      ...
      <Group name={['scenes', sceneIndex]}>
        <div className="space-y-4">
          <div className="w-full mb-2">
            ...
            <div className="w-full space-y-1">
              <Group name={['settings']}>
                ...
                >
                  <TextInput name="renderInterval" placeholder="300" className="w-[70px]" />
                </Field>
                <Field
                  className="flex flex-row gap-2 w-full justify-between"
                ...
                >
                  <TextInput type="color" name="backgroundColor" className="!p-0 w-[70px]" placeholder="#ffffff" />
                </Field>
              </Group>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            {(scene.fields ?? []).length === 0 ? <div>No fields yet. Add one to get started.</div> : null}
          </div>
        </div>
      </Group>
    </Form>
