    ...
    buildZip: [
      false,
      {
        downloadBuildZip: async () => {
          ...
          downloadBlob(await response.blob(), `frame_${props.frameId}_build.zip`)
          return false
        },
      },
    ],
    cSourceZip: [
      false,
      {
        downloadCSourceZip: async () => {
          ...
          downloadBlob(await response.blob(), `frame_${props.frameId}_c_source.zip`)
          return false
        },
      },
    ],
    binaryZip: [
      false,
      {
        downloadBinaryZip: async () => {
          ...
          downloadBlob(await response.blob(), `frame_${props.frameId}_binary.zip`)
          return false
        },
      },
    ],
