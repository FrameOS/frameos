...
export interface frameAdminUpgradeLogicValues {
  isUpgradePolling: boolean
  upgradeError: string | null
  upgradeRunningSeen: boolean
  upgradeStatus: FrameOSUpgradeStatus | null
  upgradeStatusCanReload: boolean
  upgradeStatusIsActive: boolean
  upgradeStatusLoading: boolean
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface frameAdminUpgradeLogicActions {
  checkUpgradeStatus: () => any
  checkUpgradeStatusFailure: (
    error: string,
    errorObject?: any
  ) => {
    error: string
  ...
  checkUpgradeStatusSuccess: (
    upgradeStatus: FrameOSUpgradeStatus,
    payload?: any
  ) => {
    upgradeStatus: FrameOSUpgradeStatus
    payload?: any
  ...
  loadUpgradeStatus: () => any
  loadUpgradeStatusFailure: (
    error: string,
    errorObject?: any
  ) => {
    error: string
  ...
  markUpgradeRunningSeen: () => {
    value: true
  }
  reloadAfterUpgrade: () => {
    value: true
  }
  scheduleUpgradeStatusPoll: (delayMs: number) => {
    delayMs: number
  }
  setUpgradeError: (error: string | null) => {
    error: string | null
  }
  setUpgradePolling: (polling: boolean) => {
    polling: boolean
  }
  startUpgrade: () => any
  startUpgradeFailure: (
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface frameAdminUpgradeLogicMeta {
  __keaTypeGenInternalSelectorTypes: {
    upgradeStatusIsActive: (upgradeStatus: FrameOSUpgradeStatus | null) => boolean
    upgradeStatusCanReload: (upgradeStatus: FrameOSUpgradeStatus | null) => boolean
  }
}

export type frameAdminUpgradeLogicType = MakeLogicType<
  frameAdminUpgradeLogicValues,
  frameAdminUpgradeLogicActions,
  Record<string, any>
> &
  frameAdminUpgradeLogicMeta
...
export const frameAdminUpgradeLogic = kea<frameAdminUpgradeLogicType>([
  ...
  selectors({
    upgradeStatusIsActive: [
      (s) => [s.upgradeStatus],
      (upgradeStatus: frameAdminUpgradeLogicValues['upgradeStatus']) => statusIsActive(upgradeStatus),
    ],
    upgradeStatusCanReload: [
      (s) => [s.upgradeStatus],
      (upgradeStatus: frameAdminUpgradeLogicValues['upgradeStatus']) => statusShouldReload(upgradeStatus),
    ],
  }),
