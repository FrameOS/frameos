...
/** "Private cloud scenes" section of the Templates panel: your own FrameOS
 * Cloud store scenes (private and public), installable on any frame. Shows a
 * short promo with a settings link while the cloud is not connected. */
      ...
      {expanded ? (
        !hasDriveScope ? (
          <Box className="frame-tool-card rounded-[18px] p-3 text-sm space-y-1">
            <div>
              Keep your own copy of any scene in FrameOS Cloud. It stays private to you, ready to install on any frame —
              and you can share it on the public store whenever you like.
            </div>
