import { MakeLogicType, actions, connect, kea, key, path, props, reducers, selectors, listeners } from 'kea'
...
export interface templateRowLogicValues {
  frames: Record<FrameId, FrameType> // framesModel
  canLoadRemoteScenes: boolean
  frameMode: 'buildroot' | 'embedded' | 'rpios' | undefined
  remoteScenes: FrameScene[] | null
  scenes: FrameScene[]
  trySceneConfig: {
    mainScene: FrameScene
    payloadScenes: FrameScene[]
  } | null
  trySceneFields: StateField[]
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface templateRowLogicActions {
  setRemoteScenes: (scenes: FrameScene[]) => {
    scenes: FrameScene[]
  }
  startTryScene: () => {
    value: true
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface templateRowLogicMeta {
  key: string
  __keaTypeGenInternalSelectorTypes: {
    scenes: (arg: FrameScene[] | undefined, remoteScenes: FrameScene[] | null) => FrameScene[]
    canLoadRemoteScenes: (arg: string | undefined, remoteScenes: FrameScene[] | null) => boolean
    frameMode: (
      frames: Record<FrameId, FrameType>,
      arg: FrameId | undefined
    ) => 'buildroot' | 'embedded' | 'rpios' | undefined
    trySceneConfig: (
      scenes: FrameScene[],
      frameMode: 'buildroot' | 'embedded' | 'rpios' | undefined
    ) => {
...
export type templateRowLogicType = MakeLogicType<
  templateRowLogicValues,
  templateRowLogicActions,
  TemplateRowLogicProps
> &
  templateRowLogicMeta
...
export const templateRowLogic = kea<templateRowLogicType>([
  ...
  selectors({
    scenes: [
      ...
      (scenes: FrameScene[] | undefined, remoteScenes: templateRowLogicValues['remoteScenes']) =>
        scenes ?? remoteScenes ?? [],
    ],
    canLoadRemoteScenes: [
      (s) => [(_, props: TemplateRowLogicProps) => props.template?.scenesUrl, s.remoteScenes],
      (scenesUrl: string | undefined, remoteScenes: templateRowLogicValues['remoteScenes']) =>
        Boolean(scenesUrl) && remoteScenes === null,
    ],
    frameMode: [
      (s) => [s.frames, (_, props: TemplateRowLogicProps) => props.frameId],
      (frames: templateRowLogicValues['frames'], frameId: FrameId | undefined) =>
        frameId ? frames[frameId]?.mode : undefined,
    ],
    trySceneConfig: [
