...
export interface workspaceLogicValues {
  activeFramesList: FrameType[] // framesModel
  archivedFramesList: FrameType[] // framesModel
  frames: Record<FrameId, FrameType> // framesModel
  framesList: FrameType[] // framesModel
  ...
  scheduleDrawerFrameId: FrameId | null
  search: string
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface workspaceLogicActions {
  closeChatDrawer: () => {
    value: true
  }
  ...
  focusFrame: (frameId: FrameId) => {
    frameId: FrameId
  }
  navigateToFrame: (frameId: FrameId) => {
    frameId: FrameId
  }
  navigateToScene: (
    frameId: FrameId,
  ...
  navigateToSceneFrame: (frameId: FrameId) => {
    frameId: FrameId
  }
  openChatDrawer: (
    frameId: FrameId,
  ...
  openFrameChangeDrawer: (
    ...
    deployDrawerView: DeployDrawerView | undefined
    frameId: FrameId
    kind: FrameChangeDrawerKind
    preferFrameRoute: boolean | undefined
  }
  openFrameTool: (
    frameId: FrameId,
  ...
  openScheduleDrawer: (frameId: FrameId) => {
    frameId: FrameId
  }
  ...
  rememberTerminalSessionFrame: (frameId: FrameId) => {
    frameId: FrameId
  }
  ...
  selectFrame: (frameId: FrameId | null) => {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface workspaceLogicMeta {
  __keaTypeGenInternalSelectorTypes: {
    ...
    orderedActiveFramesList: (activeFramesList: FrameType[], frameOrderSnapshot: FrameId[]) => FrameType[]
    orderedArchivedFramesList: (archivedFramesList: FrameType[], frameOrderSnapshot: FrameId[]) => FrameType[]
...
export type workspaceLogicType = MakeLogicType<workspaceLogicValues, workspaceLogicActions, Record<string, any>> &
  workspaceLogicMeta
...
export const workspaceLogic = kea<workspaceLogicType>([
  ...
  selectors({
    selectedFrame: [
      ...
      (
        frames: workspaceLogicValues['frames'],
        selectedFrameId: workspaceLogicValues['selectedFrameId'],
        activeFramesList: workspaceLogicValues['activeFramesList'],
        framesList: workspaceLogicValues['framesList']
      ): FrameType | null => {
    ...
    selectedSceneId: [
      ...
      (
        selectedFrame: workspaceLogicValues['selectedFrame'],
        selectedSceneIdsByFrame: workspaceLogicValues['selectedSceneIdsByFrame']
      ): string | null => {
        if (!selectedFrame) {
          return null
        }
    ...
    selectedScene: [
      ...
      (
        selectedFrame: workspaceLogicValues['selectedFrame'],
        selectedSceneId: workspaceLogicValues['selectedSceneId']
      ): FrameScene | null => selectedFrame?.scenes?.find((scene) => scene.id === selectedSceneId) ?? null,
    ],
    orderedActiveFramesList: [
      (s) => [s.activeFramesList, s.frameOrderSnapshot],
      (
        activeFramesList: workspaceLogicValues['activeFramesList'],
        frameOrderSnapshot: workspaceLogicValues['frameOrderSnapshot']
      ): FrameType[] => applyFrameOrderSnapshot(activeFramesList, frameOrderSnapshot),
    ],
    orderedArchivedFramesList: [
      (s) => [s.archivedFramesList, s.frameOrderSnapshot],
      (
        archivedFramesList: workspaceLogicValues['archivedFramesList'],
        frameOrderSnapshot: workspaceLogicValues['frameOrderSnapshot']
      ): FrameType[] => applyFrameOrderSnapshot(archivedFramesList, frameOrderSnapshot),
    ],
    homeActiveFramesList: [
      (s) => [s.orderedActiveFramesList, s.frameOrderSnapshot, s.frameActiveSnapshot],
      (
        orderedActiveFramesList: workspaceLogicValues['orderedActiveFramesList'],
        frameOrderSnapshot: workspaceLogicValues['frameOrderSnapshot'],
        frameActiveSnapshot: workspaceLogicValues['frameActiveSnapshot']
      ): FrameType[] =>
    ...
    filteredOverviewFrames: [
      ...
      (
        orderedActiveFramesList: workspaceLogicValues['orderedActiveFramesList'],
        search: workspaceLogicValues['search']
      ): FrameType[] => {
    ...
    overviewFrameSections: [
      ...
      (
        orderedActiveFramesList: workspaceLogicValues['orderedActiveFramesList'],
        orderedArchivedFramesList: workspaceLogicValues['orderedArchivedFramesList'],
        search: workspaceLogicValues['search']
      ): OverviewFrameSection[] => {
        const normalizedSearch = search.trim().toLowerCase()
        const frames = [
    ...
    overviewActiveFrameSections: [
      ...
      (
        overviewFrameSections: workspaceLogicValues['overviewFrameSections'],
        frameOrderSnapshot: workspaceLogicValues['frameOrderSnapshot'],
        frameActiveSnapshot: workspaceLogicValues['frameActiveSnapshot']
      ): OverviewFrameSection[] =>
    ...
    overviewArchivedFrameSections: [
      ...
      (overviewFrameSections: workspaceLogicValues['overviewFrameSections']): OverviewFrameSection[] =>
        overviewFrameSections.filter((section) => section.archived),
    ],
    filteredSelectedFrameScenes: [
      (s) => [s.selectedFrame, s.search],
      (selectedFrame: workspaceLogicValues['selectedFrame'], search: workspaceLogicValues['search']): FrameScene[] => {
        const normalizedSearch = search.trim().toLowerCase()
    ...
    allSceneOptions: [
      (s) => [s.framesList],
      (framesList: workspaceLogicValues['framesList']): WorkspaceSceneOption[] =>
