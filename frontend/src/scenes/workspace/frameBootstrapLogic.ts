...
export interface frameBootstrapLogicValues {
  copied: boolean
  error: string | null
  loading: boolean
}
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface frameBootstrapLogicActions {
  copyFrameBootstrapScript: (selectRemote?: any) => {
    selectRemote: any
  }
  copyFrameBootstrapScriptFailure: (error: string) => {
    error: string
  }
  copyFrameBootstrapScriptSuccess: () => {
    value: true
  }
  resetFrameBootstrapScriptState: () => {
    value: true
  }
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface frameBootstrapLogicMeta {
  key: FrameId
}

export type frameBootstrapLogicType = MakeLogicType<
  frameBootstrapLogicValues,
  frameBootstrapLogicActions,
  FrameBootstrapLogicProps
> &
  frameBootstrapLogicMeta
