...
export interface framesHomeLogicValues {
  framesList: FrameType[] // framesModel
  frameOrderSnapshotted: boolean
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface framesHomeLogicActions {
  ...
  markFrameOrderSnapshotted: () => {
    value: true
  }
  snapshotFrameOrderIfNeeded: () => {
    value: true
  }
  startFrameOrderSnapshot: () => {
    value: true
  }
  syncFrameFromScroll: () => {
    value: true
...
export type framesHomeLogicType = MakeLogicType<framesHomeLogicValues, framesHomeLogicActions>
