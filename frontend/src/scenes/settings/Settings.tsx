          ...
          <>
            <Form logic={settingsLogic} formKey="settings" props={{}} onSubmit={submitSettings} className="space-y-4">
              <Group name="ssh_keys">
                ...
                <Box className="p-2 space-y-2">
                  <p className="text-sm leading-loose">
                    These SSH keys are available for frame access. Choose which ones should be installed on new frames.
                  </p>
              ...
              <Group name="posthog">
                ...
                <Box className="p-2 space-y-2">
                  <Field name="backendApiKey" label="Backend API key" secret={!!savedSettings?.posthog?.backendApiKey}>
                    <TextInput />
                  </Field>
              ...
              <Group name="buildHost">
                ...
                <Box className="p-2 space-y-2">
                  <p className="text-sm leading-loose">
                    ...
                    compatibility, but this is slow and inefficient. Therefore we also support cross-compilation, where
                    we compile the FrameOS binary on this server, and only upload the resulting binary onto the device.
                  </p>
                  <p className="text-sm leading-loose">
                    Cross-compilation is performed via Docker. We need to spin up new docker containers for the various
                    build environments. If FrameOS itself is running in Docker, we will need to run Docker-in-Docker,
                    which requires elevated privileges. See the{' '}
