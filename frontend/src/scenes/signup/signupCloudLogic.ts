...
export interface signupCloudLogicValues {
  isSetupCloudConnecting: boolean
  setupCloudError: string | null
  setupCloudStatus: CloudStatus | null
  setupCloudStatusLoading: boolean
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface signupCloudLogicActions {
  cancelSetupCloud: () => {
    value: true
  }
  connectSetupCloud: () => {
  ...
  loadSetupCloudStatus: () => any
  loadSetupCloudStatusFailure: (
    error: string,
    errorObject?: any
  ) => {
    error: string
  ...
  setSetupCloudError: (error: string | null) => {
    error: string | null
  }
}

export type signupCloudLogicType = MakeLogicType<signupCloudLogicValues, signupCloudLogicActions>
