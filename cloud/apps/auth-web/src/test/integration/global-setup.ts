...
// then drop the public schema and replay all SQL migrations in order. This
// keeps the suite honest about the migration files actually producing the
...
// Postgres error 3D000: invalid_catalog_name, i.e. the database does not exist
// yet. Anything else (server down, bad credentials) should fail loudly.
