...
export default async function MyScenesPage({
  ...
  const sceneRows = accountId
    ...
    : [];
  // Plain data for the client-side grid (the table below is rendered here
  // and handed to MyScenesView as children).
  const gridRows: MyScenesRow[] = sceneRows.map((scene) => ({
