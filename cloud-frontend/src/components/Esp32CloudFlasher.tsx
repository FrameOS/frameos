...
// layoutMatchedPlatform / detectFlashSize live in the legacy workspace's
// embeddedFlashImage.ts so the self-hosted release flasher picks the image
// the same way; re-exported here for the flasher tests.
export { layoutMatchedPlatform }
