...
class FrameOSSetupScriptTest(unittest.TestCase):
    ...
    def test_standalone_install_writes_frame_json_and_starts_frameos_only(self) -> None:
        ...
        self.assertIn("WatchdogSec=900", service)
        self.assertRegex(service, r"MemoryHigh=\d+K")
        self.assertRegex(service, r"MemoryMax=\d+K")
        self.assertIn("MemorySwapMax=64M", service)
