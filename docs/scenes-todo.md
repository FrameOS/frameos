...
- When a scene ships to the store, delete its line here and add it to "Already covered" above. `cloud/apps/auth-web/evals/build-todo-scenes.ts` builds scenes straight from this list.
