...
/* The pure parsers/normalisers (`set pins`, `set rotate`, GPIO buttons …)
 * live in fos_config_parse.c so they can be host-tested; this file keeps
 * NVS, the defaults and the chip-specific pin table. */
