...
import apps/legacy/downloadImage/app as legacy_downloadImageApp
...
type Scene* = ref object of FrameScene
  node1: legacy_downloadImageApp.App
...
proc runNode*(self: Scene, nodeId: NodeId, context: var ExecutionContext) =
  ...
  while nextNode != -1.NodeId:
    ...
    timer = epochTime()
    case nextNode:
    of 1.NodeId: # legacy/downloadImage
...
proc init*(sceneId: SceneId, frameConfig: FrameConfig, logger: Logger, persistedState: JsonNode): FrameScene =
  ...
  scene.node1 = legacy_downloadImageApp.init(1.NodeId, scene.FrameScene, legacy_downloadImageApp.AppConfig(
