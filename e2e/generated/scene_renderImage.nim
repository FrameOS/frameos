...
proc init*(sceneId: SceneId, frameConfig: FrameConfig, logger: Logger, persistedState: JsonNode): FrameScene =
  ...
  scene.node5 = data_localImageApp.App(nodeId: 5.NodeId, scene: scene.FrameScene, frameConfig: scene.frameConfig, appConfig: data_localImageApp.AppConfig(
  ...
  scene.node7 = data_newImageApp.App(nodeId: 7.NodeId, scene: scene.FrameScene, frameConfig: scene.frameConfig, appConfig: data_newImageApp.AppConfig(
    width: 100,
    height: 100,
    color: parseHtmlColor("#1b9d6b"),
  ))
  scene.node6 = render_imageApp.App(nodeId: 6.NodeId, scene: scene.FrameScene, frameConfig: scene.frameConfig, appConfig: render_imageApp.AppConfig(
  ...
  scene.node9 = data_newImageApp.App(nodeId: 9.NodeId, scene: scene.FrameScene, frameConfig: scene.frameConfig, appConfig: data_newImageApp.AppConfig(
    width: 30,
    height: 30,
  ...
  scene.node10 = render_imageApp.App(nodeId: 10.NodeId, scene: scene.FrameScene, frameConfig: scene.frameConfig, appConfig: render_imageApp.AppConfig(
    placement: "center-right",
    inputImage: none(Image),
    offsetX: 0,
    offsetY: 0,
  ))
  scene.node12 = data_newImageApp.App(nodeId: 12.NodeId, scene: scene.FrameScene, frameConfig: scene.frameConfig, appConfig: data_newImageApp.AppConfig(
    width: 30,
    height: 30,
    color: parseHtmlColor("#ffffff"),
  ))
  scene.node11 = render_gradientApp.App(nodeId: 11.NodeId, scene: scene.FrameScene, frameConfig: scene.frameConfig, appConfig: render_gradientApp.AppConfig(
    inputImage: some(block:
      if cache3.isNone():
        cache3 = some(block:
          self.node12.get(context))
