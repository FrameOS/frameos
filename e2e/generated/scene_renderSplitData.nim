...
proc runEvent*(context: var ExecutionContext) =
  ...
  case context.event:
  of "render":
    try: self.runNode(7.NodeId, context)
...
proc init*(sceneId: SceneId, frameConfig: FrameConfig, logger: Logger, persistedState: JsonNode): FrameScene =
  ...
  scene.node5.init()
  scene.node7 = render_gradientApp.App(nodeId: 7.NodeId, scene: scene.FrameScene, frameConfig: scene.frameConfig, appConfig: render_gradientApp.AppConfig(
