...
import apps/data/rotateImage/app as data_rotateImageApp
...
type Scene* = ref object of FrameScene
  ...
  node7: data_rotateImageApp.App
  node8: data_rotateImageApp.App
  node9: data_rotateImageApp.App
  node10: data_rotateImageApp.App
...
proc init*(sceneId: SceneId, frameConfig: FrameConfig, logger: Logger, persistedState: JsonNode): FrameScene =
  ...
  scene.node6.init()
  scene.node7 = data_rotateImageApp.App(nodeName: "data/rotateImage", nodeId: 7.NodeId, scene: scene.FrameScene, frameConfig: scene.frameConfig, appConfig: data_rotateImageApp.AppConfig(
    rotationDegree: 0.0,
  ))
  ...
  scene.node8 = data_rotateImageApp.App(nodeName: "data/rotateImage", nodeId: 8.NodeId, scene: scene.FrameScene, frameConfig: scene.frameConfig, appConfig: data_rotateImageApp.AppConfig(
    rotationDegree: 90.0,
  ))
  ...
  scene.node9 = data_rotateImageApp.App(nodeName: "data/rotateImage", nodeId: 9.NodeId, scene: scene.FrameScene, frameConfig: scene.frameConfig, appConfig: data_rotateImageApp.AppConfig(
  ...
  scene.node10 = data_rotateImageApp.App(nodeName: "data/rotateImage", nodeId: 10.NodeId, scene: scene.FrameScene, frameConfig: scene.frameConfig, appConfig: data_rotateImageApp.AppConfig(
