...
import apps/legacy/localImage/app as legacy_localImageApp
...
type Scene* = ref object of FrameScene
  node1: legacy_localImageApp.App
...
proc init*(sceneId: SceneId, frameConfig: FrameConfig, logger: Logger, persistedState: JsonNode): FrameScene =
  ...
  scene.node1 = legacy_localImageApp.init(1.NodeId, scene.FrameScene, legacy_localImageApp.AppConfig(
