...
proc init*(sceneId: SceneId, frameConfig: FrameConfig, logger: Logger, persistedState: JsonNode): FrameScene =
  ...
  scene.node2 = logic_ifElseApp.init(2.NodeId, scene.FrameScene, logic_ifElseApp.AppConfig(
  ...
  scene.node4 = render_gradientApp.init(4.NodeId, scene.FrameScene, render_gradientApp.AppConfig(
    startColor: parseHtmlColor("#1ba179"),
    endColor: parseHtmlColor("#186d1e"),
    inputImage: none(Image),
    angle: 45.0,
  ))
  scene.node5 = render_splitApp.init(5.NodeId, scene.FrameScene, render_splitApp.AppConfig(
    columns: 2,
    inputImage: none(Image),
    rows: 1,
    render_functions: @[
  ...
  scene.node6 = render_splitApp.init(6.NodeId, scene.FrameScene, render_splitApp.AppConfig(
    rows: 6,
    inputImage: none(Image),
    columns: 1,
    render_functions: @[
  ...
  scene.node7 = logic_ifElseApp.init(7.NodeId, scene.FrameScene, logic_ifElseApp.AppConfig(
