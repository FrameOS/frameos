...
proc init*(sceneId: SceneId, frameConfig: FrameConfig, logger: Logger, persistedState: JsonNode): FrameScene =
  ...
  scene.node1 = gradientApp.init(1.NodeId, scene.FrameScene, gradientApp.AppConfig(startColor: parseHtmlColor("#2f90c1"), endColor: parseHtmlColor("#fbec46"), angle: 45.0))
  runEvent(context)
