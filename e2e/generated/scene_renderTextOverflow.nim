...
proc init*(sceneId: SceneId, frameConfig: FrameConfig, logger: Logger, persistedState: JsonNode): FrameScene =
  ...
  scene.node1 = render_gradientApp.init(1.NodeId, scene.FrameScene, render_gradientApp.AppConfig(
  ...
  scene.node6 = logic_setAsStateApp.init(6.NodeId, scene.FrameScene, logic_setAsStateApp.AppConfig(
    stateKey: "text",
  ))
  runEvent(context)
