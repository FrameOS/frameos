...
proc init*(sceneId: SceneId, frameConfig: FrameConfig, logger: Logger, persistedState: JsonNode): FrameScene =
  ...
  scene.node1 = qrApp.init(1.NodeId, scene.FrameScene, qrApp.AppConfig(
    position: "top-left",
    alRad: 80.0,
    offsetX: 20.0,
    offsetY: 4.0,
  ...
  scene.node2 = qrApp.init(2.NodeId, scene.FrameScene, qrApp.AppConfig(
  ...
  scene.node3 = qrApp.init(3.NodeId, scene.FrameScene, qrApp.AppConfig(
    codeType: "Custom",
    code: "hello",
    position: "top-right",
    moSep: 80.0,
  ...
  scene.node4 = qrApp.init(4.NodeId, scene.FrameScene, qrApp.AppConfig(
    codeType: "Custom",
    code: "world",
  ...
  scene.node5 = qrApp.init(5.NodeId, scene.FrameScene, qrApp.AppConfig(
    moRad: 50.0,
    moSep: 50.0,
  ...
  scene.node6 = qrApp.init(6.NodeId, scene.FrameScene, qrApp.AppConfig(
  ...
  scene.node7 = qrApp.init(7.NodeId, scene.FrameScene, qrApp.AppConfig(
