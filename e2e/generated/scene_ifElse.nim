...
proc init*(sceneId: SceneId, frameConfig: FrameConfig, logger: Logger, persistedState: JsonNode): FrameScene =
  ...
  scene.node1 = splitApp.init(1.NodeId, scene.FrameScene, splitApp.AppConfig(rows: 3, columns: 3, width_ratios: "1 2 1", height_ratios: "2 1 2", render_functions: @[@[0.NodeId, 0.NodeId, 0.NodeId], @[0.NodeId, 0.NodeId, 0.NodeId], @[0.NodeId, 0.NodeId, 0.NodeId]], render_function: 2.NodeId))
