...
1. No open non-legacy P0/P1 gaps remain after `FTEST-062`; continue only with optional P2/backlog scope decisions.
2. Optional: decide whether legacy app modules under `src/apps/legacy/*` and autogenerated `src/scenes/default.nim` warrant dedicated tests or explicit out-of-scope status.
