...
- [ ] `FTEST-064` (`READY`): Add deterministic driver helper coverage for debug/log and process wrappers.
...
1. Pick `FTEST-064` (driver helper coverage for waveshare/inky wrappers).
