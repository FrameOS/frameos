# This code is autogenerated. src/scenes/scene_e1cf34281de84fa3aa3c3158905c0ec8.nim
...
proc init*(sceneId: SceneId, frameConfig: FrameConfig, logger: Logger, persistedState: JsonNode): FrameScene =
  ...
  scene.node1 = frameOSGalleryApp.init(1.NodeId, scene.FrameScene, frameOSGalleryApp.AppConfig(category: "cute",
      scalingMode: "cover", cacheSeconds: 3600.0))
  runEvent(context)
